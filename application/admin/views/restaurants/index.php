                    ...
                    <div class="page-header">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                ...
                                <li><a href="<?= RESTAURANTS_PATH ?>"><?= $this->lang->line('restautant_list') ?></a></li>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card alert">
                            ...
                            <div class="pull-right">
                                <a class="btn btn-success btn-flat m-b-10 m-l-5" style="margin-right:15px!important" href="<?= RESTAURANTS_PATH ?>/add"><?= $this->lang->line('add_restaurant') ?></a>
                                <input class="btn btn-danger btn-flat m-b-10 m-l-5" type="submit" onclick="multiple_delete('<?= RESTAURANTS_PATH ?>/multiple_delete')" id="postme" value="Delete" disabled="disabled">
                                        ...
                                        if (!empty($results)) {
                                            ...
                                            foreach ($results as $single) { ?>
                                                <tr>
                                                    ...
                                                    <td>&nbsp;&nbsp;<a class="fa fa-eye" data-toggle="tooltip" style="color: #00c0ef;" title="<?= $this->lang->line('view') ?>!" href="<?= RESTAURANTS_PATH ?>/view/<?= $single['id'] ?>"></a>&nbsp;&nbsp;<a class="ti-pencil-alt" data-toggle="tooltip" style="color: #00c0ef;" title="<?= $this->lang->line('edit') ?>!" href="<?= RESTAURANTS_PATH ?>/edit/<?= $single['id'] ?>"></a>&nbsp;&nbsp;
                                                        ...
                                                        <a href="javascript:void(0)" class="ti-trash" style="color:red" data-toggle="tooltip" title="<?= $this->lang->line('delete') ?>!" onclick="delete_status('<?= RESTAURANTS_PATH ?>/delete', '<?= $single['id'] ?>')"></a>&nbsp;&nbsp;
                                                        <a href="<?= RESTAURANTS_PATH ?>/invoice/<?= $single['id'] ?>" class="fa fa-file" style="color:green" data-toggle="tooltip" title="<?= $this->lang->line('view_invoice') ?>"></a></td>
                                                </tr>
                                        <?php
