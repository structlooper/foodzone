            ...
            <div class="main-content">
                ...
                <div class="row">
                                    ...
                                    <table class="table table-borderless table-sm table-responsive custom-table">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right"><?=$restaurant_info->is_available==1?("<lable class='label label-success'>".$this->lang->line('available')."</label>"): ("<lable class='label label-danger'>".$this->lang->line('unavailable')."</label>"); ?></td>
                                            </tr>
                                            <tr>
                    ...
                    <div class="col-lg-6">
                        <div class="card alert">
                            <div class="card-header">
                                <h4><?=$this->lang->line('contact_and_address_information')?></h4>
                            </div>
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-xs-12">
                                ...
                                <table id="bootstrap-data-table<?=$cats['id']?>" class="table table-striped table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <th><?=$this->lang->line('food_type')?></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                <?php
