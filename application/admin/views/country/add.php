                    ...
                    <div class="page-header">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                ...
                                <li><a href="<?= COUNTRY_PATH ?>"><?= $this->lang->line('country_list') ?></a></li>
                                <li><a class="active" href="javascript:void(0)"><?=$this->lang->line('add_country')?></a></li>
                        ...
                        <div class="card alert">
                            ...
                            <div class="card-body">
                                <div class="menu-upload-form">
                                    ...
                                    <form class="form-horizontal" action="<?= COUNTRY_PATH ?>/add" method="post" accept-charset="utf-8" id="addCategory">
