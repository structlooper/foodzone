                        ...
                        <div class="card alert">
                            ...
                            <div class="card-body">
                                <div class="menu-upload-form">
                                    ...
                                    <form class="form-horizontal" action="<?= COUPONS_PATH ?>/edit/<?= $results->id ?>" method="post" accept-charset="utf-8" id="editOwner" enctype="multipart/form-data">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="col-sm-2 control-label"><?= $this->lang->line('coupon_code') ?>:</label>
                                                    <div class="col-sm-10">
                                                        <input id="coupon_code" class="form-control required" type="text" name="coupon_code" placeholder="<?= $this->lang->line('enter_coupon_code') ?>" value="<?= urldecode($results->coupon_code); ?>">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <textarea id="description" class="form-control required" name="description" placeholder="<?= $this->lang->line('enter_descripton') ?>"><?= urldecode($results->description); ?></textarea>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input id="start_date" class="form-control required" type="date" name="start_date" placeholder="<?= $this->lang->line('enter_start_date') ?>" value="<?= urldecode($results->start_date); ?>">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input id="end_date" class="form-control required" type="date" name="end_date" placeholder="<?= $this->lang->line('enter_end_date') ?>" value="<?= urldecode($results->end_date); ?>">
                                                        <?= form_error('end_date'); ?>
                                                    </div>
                                                </div>
                                            </div>
