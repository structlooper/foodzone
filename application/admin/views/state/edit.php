                        ...
                        <div class="card alert">
                            ...
                            <div class="card-body">
                                <div class="menu-upload-form">
                                    ...
                                    <form class="form-horizontal" action="<?= STATE_PATH ?>/edit/<?= $results->id ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data" id="addState">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <select class="form-control required" name="country_id" id="country_id">
                                                    ...
                                                    <option value="<?= $row['id']; ?>" <?= $row['id'] == $results->country_id ? 'selected' : '' ?>><?= urldecode($row['name']); ?></option>
                                                    <?php } ?>
                                                </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input id="name" class="form-control required" type="text" name="name" value="<?= urldecode($results->name); ?>" placeholder="<?=$this->lang->line('enter_name')?>">
                                                <?= form_error('name'); ?>
                                            </div>
                                        </div>
