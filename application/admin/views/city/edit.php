                    ...
                    <div class="page-header">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                ...
                                <li><a class="active" href="javascript:void(0)"><?= $this->lang->line('edit_city') ?></a></li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /# column -->
                        ...
                        <div class="card alert">
                            ...
                            <div class="card-body">
                                <div class="menu-upload-form">
                                    ...
                                    <form class="form-horizontal" action="<?= CITY_PATH ?>/edit/<?= $results->id ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data" id="addState">
