                    ...
                    <div class="page-header">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                ...
                                <li><a class="active" href="javascript:void(0)"><?=$this->lang->line('add_notification')?></a></li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /# column -->
                        ...
                        <div class="card alert">
                            ...
                            <div class="card-body">
                                <div class="menu-upload-form">
                                    ...
                                    <form class="form-horizontal" action="<?= NOTIFICATION_PATH ?>/add" method="post" accept-charset="utf-8" enctype="multipart/form-data" id="addNotification">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <textarea id="description" class="form-control required" name="description" placeholder="<?=$this->lang->line('enter_description')?>"><?= set_value('description') ?></textarea>
